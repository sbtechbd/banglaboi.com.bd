...
$simularity_scores = wcbs_recommender_get_simularity( get_the_ID(), 'viewed' );
...
$args = apply_filters( 'woocommerce_related_products_by_viewed_args', array(
	'post_type' 			=> 'product',
...
if ( $products && is_array( $products ) && count( $products ) ) :
	...
	$section_title 		= ! empty( $get_section_title ) ? $get_section_title : esc_html__( 'Customers also viewed these products', 'pustaka' );
	?>
