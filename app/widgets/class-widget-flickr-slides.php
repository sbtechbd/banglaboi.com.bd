...
class pustaka_Flickr_Photo_Slides extends Tokoo_Widget {
	...
	function __construct() {
		...
		$args = array(
			'label' 		=> esc_html__( 'Tokoo - Flickr Photo Slides', 'pustaka' ),
			'description' 	=> esc_html__( 'A custom widget to display the flickr photo in slide display.', 'pustaka' ),
		 );
		...
		$args['fields'] = array(
			...
			array(
				...
				'type' 		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> esc_html__( 'Flickr Photo Slides', 'pustaka' ),
				'validate' 	=> 'alpha_dash',
			...
			// Width
			array(
				'name'		=> esc_html__( 'Flickr ID', 'pustaka' ),
			...
			// Width
			array(
				'name'		=> esc_html__( 'How many photos will be displayed', 'pustaka' ),
				'id' 		=> 'count',
				'type'		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> 6,
			...
			// Width
			array(
				'name'		=> esc_html__( 'Thumbnail Width', 'pustaka' ),
				'id' 		=> 't_width',
				'type'		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> 80,
			...
			// Width
			array(
				'name'		=> esc_html__( 'Thumbnail Height', 'pustaka' ),
				'id' 		=> 't_height',
				'type'		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> 80,
		...
		$this->defaults = apply_filters( 'pustaka_flickr_widget_modify_defaults', $this->defaults );
	}
	...
	function get_photos( $id, $count = 8 ) {
		...
		$transient_key 	= md5( 'pustaka_flickr_slides_cache_' . $id . $count );
